    ...
    <section id="case-study" className="py-20 sm:py-28 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* 1. Problem */}
          <motion.div
            className="apple-glass-card p-6 sm:p-7 rounded-2xl bg-white/95 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800 shadow-xs flex flex-col justify-between"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div>
              ...
              <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-3 tracking-tight">
        ...
        {/* Tools Strip */}
        <motion.div
          className="mt-8 apple-glass p-5 rounded-2xl bg-white/95 dark:bg-zinc-900/90 border border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs"
          initial={{ opacity: 0 }}
